...
export const OUTBREAK_ATTRIBUTES = {
  ...
  /* South East Asia */
  'India': { emoji: '🇮🇳', region: 'seasia',
    links: { 'Wikipedia': 'https://en.wikipedia.org/wiki/2020_coronavirus_outbreak_in_India' }},
  'Bangladesh': { emoji: '🇧🇩', region: 'seasia' },
  'Bhutan': { emoji: '🇧🇹', region: 'seasia' },
  'Sri Lanka': { emoji: '🇱🇰', region: 'seasia' },
  'Indonesia': { emoji: '🇮🇩', region: 'seasia' },
  'Maldives': { emoji: '🇲🇻', region: 'seasia', esDisplayName: 'Maldivas' },
  'Myanmar': { emoji: '🇲🇲', region: 'seasia' },
  'Nepal': { emoji: '🇳🇵', region: 'seasia' },
